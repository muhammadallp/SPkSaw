                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <a  class="btn btn-outline-primary btn-sm m-2" id="btn-dropdown" target="_blank" href="./cetakalternatif.php"><i class="fa fa-print"></i> Cetak Pdf</a>
                                    <hr>
...
while ($row = $result->fetch_object()) {
    echo "<tr>
        ...
        <td>
                ...
                <a class='btn btn-info' href='alternatif-edit.php?id={$row->id_alternative}'>Edit</a>
                <a class='btn btn-danger' href='alternatif-hapus.php?id={$row->id_alternative}'>Hapus</a>
