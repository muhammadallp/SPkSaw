...
?>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header">
                  ...
                  <a  class="btn btn-outline-primary btn-sm mb-2" id="btn-dropdown" target="_blank" href="./cetakpreferensi.php"><i class="fa fa-print"></i> Cetak Pdf</a>
  ...
  <?php
$sql1 = 'SELECT * FROM saw_evaluations';
